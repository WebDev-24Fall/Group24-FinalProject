  ...
  return (
    <div className={styles.aboutUs}>
      <div className="container mx-auto p-6 relative z-10 bg-black/[.75]">
        ...
        <h2 className="mb-10 md:mb-20 text-center text-lg md:text-2xl">
          Final Project - Group 24
        </h2>
        <div className="flex flex-col flex-flow md:flex-row justify-center gap-3 px-3">
          ...
          <div className="md:w-1/2">
            ...
            <p className="my-3">
              "React simplifies web development with a component-based approach
              and virtual DOM for fast, dynamic user interfaces."
            </p>
